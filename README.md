...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cucumber-tag-expressions-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12933&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cucumber-tag-expressions-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cucumber-tag-expressions` can be installed with:

```
conda install cucumber-tag-expressions
```

It is possible to list all of the versions of `cucumber-tag-expressions` available on your platform with:
